...
const Button = ({ title, variant = "default", ...props }: ButtonType) => {
  // "w-full cursor-pointer rounded-md border-2 border-[#C92A0E] bg-[#C92A0E] py-2 text-sm font-bold text-white"
  //   const-outline = "w-full cursor-pointer rounded-md border-2 border-[#C92A0E] bg-[#C92A0E] py-2 text-sm font-bold text-white"
